...
mod_config_install_sddm () {

	local src_dir_path="${REF_BASE_DIR_PATH}/asset/overlay/etc/sddm.conf.d"
	local des_dir_path="/etc/sddm/sddm.conf.d"


	sudo_util_copy_from_srcdir_to_desdir "${src_dir_path}" "${des_dir_path}"
